...
@section('content')
    ...
    return 0;
                    ...
                    <h4>Komentar</h4>
                    <p>Komentar biasanya digunakan untuk mendeskripsikan suatu kode atau intruksi tertentu. Tujuannya agar mempermudah programmer dalam bekerja. Penulisan komentar dalam bahasa c adalah sebagai berikut :</p>
                    <!-- Code Example -->
                    <div class="example-code">
                        <div class="code">
                            <!-- Please write exact structures code -->
