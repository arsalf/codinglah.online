...
$(document).ready(function($) {
    ...
    $("#btn-create").click(function(e) {
        ...
        var type = "POST";
        var ajaxurl = '/manager/page/tutorial/create';
        $.ajax({
            type: type,
            url: ajaxurl,
            data: formData,
            ...
            success: function(data) {
                ...
                <tr id="` + data.id + `" class="` + data.id_bahasa + `">
                    ...
                    <td id="title_` + data.id + `" style="width: 30%">` + data.title + `</td>
    ...
    $('#list_bahasa').on('click', ".btn-update", function(e) {
        ...
        var type = "POST";
        var ajaxurl = '/manager/page/tutorial/update';
        $.ajax({
            type: type,
            url: ajaxurl,
            data: formData,
    ...
    $('#list_bahasa').on('click', ".btn-delete", function(e) {
        ...
        var type = "POST";
        var ajaxurl = '/manager/page/tutorial/delete';
        $.ajax({
            type: type,
            url: ajaxurl,
            data: formData,
