(function($) {
    ...
    $(function() {
        ...
        if ($("#performaneLine-dark").length) {
            ...
            saleGradientBg2.addColorStop(0, 'rgba(0, 208, 255, 0.19)');
            saleGradientBg2.addColorStop(1, 'rgba(34, 36, 55, 0.5)');
        ...
        if ($("#newAccountChart").length) {
            var newAccountChartCanvas = document.getElementById("newAccountChart").getContext('2d');
            ...
            var newAccountChart = new Chart(newAccountChartCanvas, {
                type: 'bar',
                data: newAccountData,
                options: newAccountOptions
            });

            // document.getElementById('newAccount-chart-legend').innerHTML = newAccountChart.generateLegend();
        }
    });
})(jQuery);